...
def main():
  ...
  # MAKE SURE YOUR EMMA LIST IS IN CSV(regular CSV is ok)

  time.sleep(3)
  print("-------------------------------------------------------------------------------------")
  print("Emma email script: opting out all the emails that have never received an email in 3 months or longer back from now.\n")
  print("Accounts that were sent an email within the 3 months timeframe will be kept as active!")
  time.sleep(10)
  print("-------------------------------------------------------------------------------------")
  print("Reminder: the 3 months from today's date is: " + str(three_months_period_date_check) + 
  ...
  if(total_emails_count<1):
    ...
    print("*************************************************************")
    print("There has been total " + str(invalid_emails_count)+" invalid emails out of total "+str(total_emails_count)+ 
    " emails processed in Emma.\n") 
    print("There has been " + str(opted_out_emails_count) +"/"+str(total_emails_count) + " active emails opted out and " + str(active_emails_count)+
      "/"+str(total_emails_count) + "remained as active.\n" )
